...
fig.tight_layout()
plt.savefig('plots/map_state_percentage.png',dpi=300)
...
fig.tight_layout()
plt.savefig('plots/map_state_stats_change.png',dpi=300)
...
fig.tight_layout()
plt.savefig('plots/map_state_stats_change_absolute.png',dpi=300)
