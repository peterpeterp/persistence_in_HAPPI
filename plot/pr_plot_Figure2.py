...
for model in ['MIROC5','NorESM1','ECHAM6-3-LR','CAM4-2degree']:
	summary[model]=da.read_nc('data/'+model+'/pr_'+model+'_diff_JJA-dry_1x1.nc')
...
plt.suptitle('Changes in JJA dry persistence', fontweight='bold')
fig.tight_layout()
plt.savefig('plots/pr_Figure2.png',dpi=300)
