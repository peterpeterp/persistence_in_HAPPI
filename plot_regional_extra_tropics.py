...
SH_regs={'WSA':{'color':20,'pos':(-90,-30),'summer':'DJF','winter':'JJA'},
		...
		'SHml':{'color':20,'pos':(-145,-35),'xlabel':'days','ylabel':'PDF','title':'','summer':'DJF','winter':'JJA'}}
...
for season in ['summer','winter']:
	for state in ['warm','cold']:
		fig=srex_overview.srex_overview(distrs,axis_settings,polygons=polygons,reg_info=all_regs,arg1=season,arg2=state,x_ext=[-180,180],y_ext=[-64,80],small_plot_size=0.08,legend_plot=legend_plot,legend_pos=[93,-30])
...
for season in ['summer','winter']:
	for state in ['warm','cold']:
		fig=srex_overview.srex_overview(scenario_diff,axis_settings,polygons=polygons,reg_info=all_regs,arg1=season,arg2=state,x_ext=[-180,180],y_ext=[-64,80],small_plot_size=0.08,legend_plot=legend_plot,legend_pos=[93,-30])
