...
# tmp_1=da.read_nc('data/ECHAM6_SummaryMeanQu.nc')['SummaryMeanQu']
# tmp_2=da.read_nc('data/ECHAM6_SummaryKS.nc')['SummaryKS']
# sum_dict['ECHAM6']=da.concatenate((tmp_1,tmp_2),axis='type')

tmp_1=da.read_nc('data/CAM4_SummaryMeanQu.nc')['SummaryMeanQu']
tmp_2=da.read_nc('data/CAM4_SummaryKS.nc')['SummaryKS']
sum_dict['CAM4']=da.concatenate((tmp_1,tmp_2),axis='type')

tmp_1=da.read_nc('data/CanAM4_SummaryMeanQu.nc')['SummaryMeanQu']
tmp_2=da.read_nc('data/CanAM4_SummaryKS.nc')['SummaryKS']
sum_dict['CanAM4']=da.concatenate((tmp_1,tmp_2),axis='type')
