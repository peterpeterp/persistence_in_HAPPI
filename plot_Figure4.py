...
fig,axes = plt.subplots(nrows=2,ncols=1,figsize=(10,3),subplot_kw={'projection': plate_carree},gridspec_kw = {'height_ratios':[3,1]})
for ax in axes[::2]:
...
cb=fig.colorbar(im,orientation='horizontal',label='eddy kinetic energy [m2/s2]',ax=cbar_ax)

plt.suptitle('Changes in EKE in JJA', fontweight='bold')
fig.tight_layout()
plt.savefig('plots/Figure4.png',dpi=300)
