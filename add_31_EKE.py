...
for scenario in scenarios:
	...
	for run in run_list:
		result=try_several_times('cdo -O mergetime -cat "monEKE_'+model+'_'+scenario+'_'+run+'*" monEKE_'+model+'_'+scenario+'_'+run+'.nc')
		if result!='failed':
			os.system('rm monEKE_'+model+'_'+scenario+'_'+run+'*')
		asdasd
