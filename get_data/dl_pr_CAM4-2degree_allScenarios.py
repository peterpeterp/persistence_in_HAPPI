...
for run in model_dict[model]['runs'][scenario]:
    if os.path.isfile("pr_Aday_CAM4-2degree_All-Hist_est1_v1-0_"+run+"_20060101-20151231.nc") == False:
...
for run in model_dict[model]['runs'][scenario]:
    if os.path.isfile("pr_Aday_CAM4-2degree_Plus20-Future_CMIP5-MMM-est1_v2-0_"+run+"_21060101-21151231.nc") == False:
...
for run in model_dict[model]['runs'][scenario]:
    if os.path.isfile("pr_Aday_CAM4-2degree_Plus15-Future_CMIP5-MMM-est1_v2-0_"+run+"_21060101-21151231.nc") == False:
