...
for run in model_dict[model]['runs'][scenario]:
    if os.path.isfile("tas_Aday_MIROC5_All-Hist_CMIP5-MMM-est1_v2-0_"+run+"_20060101-20161231.nc") == False:
        ...
        urlretrieve("http://portal.nersc.gov/cascade/data/rtrack.php?source=NERSCDisk&filename=MIROC/MIROC5/All-Hist/est1/v2-0/day/atmos/tas/"+run+"/tas_Aday_MIROC5_All-Hist_est1_v2-0_"+run+"_20150101-20151031.nc","tmp/tas_Aday_MIROC5_All-Hist_est1_v2-0_"+run+"_20150101-20151031.nc", hook)
        print('\n')
        print("downloading: tas_Aday_MIROC5_All-Hist_est1_v2-0_"+run+"_20151101-20151231.nc")
        urlretrieve("http://portal.nersc.gov/cascade/data/rtrack.php?source=NERSCDisk&filename=MIROC/MIROC5/All-Hist/est1/v2-0/day/atmos/tas/"+run+"/tas_Aday_MIROC5_All-Hist_est1_v2-0_"+run+"_20151101-20151231.nc","tmp/tas_Aday_MIROC5_All-Hist_est1_v2-0_"+run+"_20151101-20151231.nc", hook)
        print('\n')
