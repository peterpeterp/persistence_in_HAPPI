...
'''
for model in MIROC5 NorESM1; do nohup python analysis_spi/sep_grid_SPI_compute.py $model > out/$model+spi & expect "nohup: ignoring input and redirecting stderr to stdout" { send "\r" }; done;
