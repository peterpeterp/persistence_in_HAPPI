...
legax = fig.add_axes([0.825,0.15,0.17,0.8], zorder=100)
...
y-=1.5
for icon_name,icon_realname in zip(['EKE','SPI3','rain'],['EKE','SPI3','change in number of rain/dry days']):
...
plt.savefig('plots/final/NH_summary_drive.pdf', dpi=600)
