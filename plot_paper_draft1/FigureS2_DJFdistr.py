...
fig,ax_map=srex_overview.srex_overview(distrs,axis_settings,polygons=polygons,reg_info=all_regs,arg1='winter',arg2='cold', x_ext=[-180,180], y_ext=[0,85], small_plot_size=0.08, legend_plot=legend_plot, legend_pos=[163,70], title='cold persistence distributions in DJF')
plt.savefig('plots/paper/FigureS2_DJFdistr.png',dpi=600)
