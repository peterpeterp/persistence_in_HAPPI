...
NH_regs={'ALA':{'hatch':' ','color':'darkgreen','pos_off':(+10,+7),'summer':'JJA','winter':'DJF'},
		...
		'NHml':{'hatch':'///','color':'white','pos':(-142,37),'xlabel':'period length [days]','ylabel':'exceedence probability [%]','title':'','summer':'JJA','winter':'DJF','scaling_factor':1.3}}
...
def axis_settings(subax,label='off'):
	...
	locmin = mticker.LogLocator(base=10, subs=np.arange(0.2,1,0.2),numticks=5)
...
fig,ax_map=srex_overview.srex_overview(distrs,axis_settings,polygons=polygons,reg_info=all_regs,arg1='summer',arg2='warm', x_ext=[-180,180], y_ext=[0,85], small_plot_size=0.08, legend_plot=legend_plot, legend_pos=[163,70], title='exceedance probabilites for warm persistence in JJA')
plt.savefig('plots/paper/stats_exceedanceHist_precise.png',dpi=600)
fig,ax_map=srex_overview.srex_overview(distrs,axis_settings,polygons=polygons,reg_info=all_regs,arg1='winter',arg2='cold', x_ext=[-180,180], y_ext=[0,85], small_plot_size=0.08, legend_plot=legend_plot, legend_pos=[163,70], title='exceedance probabilites for cold persistence in DJF')
plt.savefig('plots/paper/stats_exceedanceHist_DJF_precise.png',dpi=600)
