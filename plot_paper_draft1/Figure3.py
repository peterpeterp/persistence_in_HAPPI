...
fig,ax_map=srex_overview.srex_overview(scenario_diff,axis_settings,polygons=polygons,reg_info=all_regs,arg1='summer',arg2='warm',x_ext=[-180,180],y_ext=[0,85],small_plot_size=0.08,legend_plot=legend_plot, legend_pos=[163,12], title='Relative change in probability of exceeding dry period lengths in JJA')
plt.savefig('plots/paper/Figure3.png',dpi=600)
