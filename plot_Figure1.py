...
NH_regs={'ALA':{'hatch':' ','color':'darkgreen','pos_off':(-23,-2),'summer':'JJA','winter':'DJF'},
		...
		'NHml':{'hatch':'///','color':'white','pos':(-145,25),'xlabel':'days','ylabel':'PDF','title':'','summer':'JJA','winter':'DJF','scaling_factor':1.3}}
...
fig,ax_map=srex_overview.srex_overview(distrs,axis_settings,polygons=polygons,reg_info=all_regs,arg1='summer',arg2='warm', x_ext=[-180,180], y_ext=[0,85], small_plot_size=0.08, legend_plot=legend_plot, legend_pos=[163,60], title='warm persistence distributions in JJA')
plt.savefig('plots/Figure1.png',dpi=600)
