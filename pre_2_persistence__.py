...
in_file=working_path+'tas_Aday_ECHAM6-3-LR_Plus20-Future_CMIP5-MMM-est1_v2-0_run010.nc'
print in_file
...
if len(test.time/365.)>9.:
	if in_file.split('_')[-1]!='period.nc' and run_count<100:
		...
		try:
			...
			os.system('cdo -O mul '+in_file+' data/tests/landmask_'+grid+'_NA-1.nc '+land_file)
